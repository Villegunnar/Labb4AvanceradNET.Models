...
namespace Labb4AvanceradNET.Models
{
    public class ProgramDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Interest>().HasData(padel);
           ...
           // });
            ...
            // Data for Webbsites
            modelBuilder.Entity<Webbsite>().HasData(new Webbsite { Id = 1, WebbsiteName = "World Padel Tour", WebbsiteAdress = "https://www.worldpadeltour.com", interest  = padel });
            modelBuilder.Entity<Webbsite>().HasData(new Webbsite { Id = 2, WebbsiteName = "PGA Tour", WebbsiteAdress = "https://www.pgatour.com", FInterestId = 2 });
            modelBuilder.Entity<Webbsite>().HasData(new Webbsite { Id = 3, WebbsiteName = "NBA", WebbsiteAdress = "https://www.nba.com", FInterestId = 3 });
            modelBuilder.Entity<Webbsite>().HasData(new Webbsite { Id = 4, WebbsiteName = "Crossfit", WebbsiteAdress = "https://www.crossfit.com", FInterestId = 4 });
            modelBuilder.Entity<Webbsite>().HasData(new Webbsite { Id = 5, WebbsiteName = "Runners World", WebbsiteAdress = "https://www.runnersworld.com", FInterestId = 5 });
